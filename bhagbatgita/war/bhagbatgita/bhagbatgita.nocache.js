...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "bhagbatgita" because\n';
  ...
  $wnd.__gwt_activeModules['bhagbatgita'] = {
    'moduleName' : 'bhagbatgita',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/bhagbatgita.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['bhagbatgita'].superdevmode = true;

  var expectedSuffix = '/bhagbatgita.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + bhagbatgita + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:bhagbatgita';
  var devModeSessionKey = '__gwtDevModeSession:bhagbatgita';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/bhagbatgita/bhagbatgita.nocache.js';
  ...
  $wnd.__gwt_activeModules['bhagbatgita'].canRedirect = true;
  $wnd.__gwt_activeModules['bhagbatgita'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/bhagbatgita?user.agent=' + ua + '&_callback=' + callback;
